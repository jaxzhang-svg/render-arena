    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Popup className={cn(
          ...
          "h-[90vh] max-w-[600px] flex flex-col overflow-hidden rounded-[10px]",
          "bg-black p-0"
        )}>
          {/* Close Button */}
          <button
            onClick={() => onOpenChange(false)}
            className="absolute right-4 top-4 z-50 rounded-full p-2 text-white/50 transition-colors border border-primary hover:bg-white/10 hover:text-white focus:outline-none cursor-pointer"
            type="button"
            aria-label="Close"
          >
            <X className="size-5" />
          ...
          <div className={cn(
            ...
            "[&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-[#0f0f0f] [&::-webkit-scrollbar-thumb]:bg-[#333] hover:[&::-webkit-scrollbar-thumb]:bg-[#444]"
          )}>
            {/* Header */}
          ...
          <div className="
            ...
            border-[rgba(255,255,255,0.1)] bg-black/80 backdrop-blur-md p-6
          ">
            <Button
              className="
