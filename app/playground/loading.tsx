    ...
    <div className="flex h-screen flex-col overflow-hidden bg-white">
      ...
      <main className="relative flex w-screen flex-1 overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 z-50 w-[90%] max-w-[720px] -translate-x-1/2">
            <div className="relative overflow-hidden rounded-[16px] border border-white/50 bg-white/90 shadow-[0px_20px_40px_-12px_rgba(0,0,0,0.15)] backdrop-blur p-4 pb-2">
                <Skeleton className="h-6 w-32 rounded-full mb-3" />
                <Skeleton className="h-[48px] w-full rounded-md mb-2" />
                <div className="flex justify-between items-center border-t border-[#e7e6e2]/80 pt-2">
